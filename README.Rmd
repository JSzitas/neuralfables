...
[![Codecov test coverage](https://codecov.io/gh/JSzitas/neuralfables/branch/main/graph/badge.svg)](https://codecov.io/gh/JSzitas/neuralfables?branch=main)
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#experimental)
[![CRAN status](https://www.r-pkg.org/badges/version/neuralfables)](https://CRAN.R-project.org/package=neuralfables)
<!-- badges: end -->
...
Currently only the development version from [GitHub](https://github.com/) with:
